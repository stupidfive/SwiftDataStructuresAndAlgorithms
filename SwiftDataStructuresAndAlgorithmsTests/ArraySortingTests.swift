...
class ArraySortingTests: XCTestCase {
	...
	func testSelectionSort() {
		...
		ArraySorting.selectionSort(&constantArray)
		ArraySorting.selectionSort(&inOrderArray)
		ArraySorting.selectionSort(&reverseArray)
		ArraySorting.selectionSort(&randomArray)
		ArraySorting.selectionSort(&largeRandomArray)
		ArraySorting.selectionSort(&doubleArray)
		ArraySorting.selectionSort(&stringArray)
	...
	func testQuickSort() {
		...
		ArraySorting.quickSort(&constantArray)
		ArraySorting.quickSort(&inOrderArray)
		ArraySorting.quickSort(&reverseArray)
		ArraySorting.quickSort(&randomArray)
		ArraySorting.quickSort(&largeRandomArray)
		ArraySorting.quickSort(&doubleArray)
		ArraySorting.quickSort(&stringArray)
